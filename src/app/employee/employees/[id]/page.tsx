...
export default function EmployeeViewColleagueDetailPage() {
      ...
      <div className="container mx-auto py-8 text-center">
        <Card className="max-w-md mx-auto shadow-lg">
          ...
          <CardContent>
            ...
            <Button onClick={() => router.push("/employee/employees")} className="mt-6"><ArrowLeft className="mr-2 h-4 w-4" /> Back to Colleagues</Button>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
      <div className="flex justify-between items-center">
        <Button variant="outline" onClick={() => router.push("/employee/employees")} className="mb-6">
          <ArrowLeft className="mr-2 h-4 w-4" /> Back to All Colleagues
        </Button>
      </div>
