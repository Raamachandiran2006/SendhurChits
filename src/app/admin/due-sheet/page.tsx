...
import React, { useEffect, useState, useMemo } from "react"; // Added React
...
export default function AdminDueSheetPage() {
  ...
  const fetchEmployeesForSms = async () => {
    if (employeesForSms.length > 0) return; // Don't refetch if already loaded
  ...
  const handleOpenEmployeeDialog = () => {
    ...
    fetchEmployeesForSms(); // Fetch employees when dialog is about to open
